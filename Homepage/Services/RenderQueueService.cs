...
namespace Homepage.Services
{
    ...
    public class RenderQueueService : IRenderQueueService
    {
        ...
        void IRenderQueueService.Enqueue(QueuedContent component)
        {
            ...
            if (renderImmediately) component.Render();
        }
        ...
        private void OnComponentRendered(QueuedContent component) => RenderNext();

        private void OnComponentDisposed(QueuedContent component) => RenderNext();
